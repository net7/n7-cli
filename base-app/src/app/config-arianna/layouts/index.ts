import entitaLayoutConfig from './entita-layout.config';
import galleryLayoutConfig from './gallery-layout.config';
import homeLayoutConfig from './home-layout.config';
...
export default {
  ...
  'scheda-layout': schedaLayoutConfig,
